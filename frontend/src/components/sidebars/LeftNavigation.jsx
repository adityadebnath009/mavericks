...
const LeftNavigation = () => {
  ...
  return (
    <div className="flex flex-col bg-[#0D1B2A] border-r border-[#20384D] w-64 h-full text-[#EAF4F8]">
        ...
        <div>
          ...
          <ul className="space-y-1 relative before:absolute before:inset-y-0 before:left-[5px] before:w-[1px] before:bg-[#20384D]">
            {recentQueries.map((query, idx) => (
              <li key={idx} className="relative pl-5 py-1 text-xs text-[#EAF4F8] hover:text-[#00D4FF] cursor-pointer group flex items-center">
      ...
      <div className="p-4 border-t border-[#20384D] bg-[#07111F]">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-[#8FA8B8] text-[10px] uppercase font-mono tracking-wider">Agents Online</span>
        </div>
      </div>
